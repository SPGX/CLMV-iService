...
const ScannerScreen: React.FunctionComponent<IScannerScreen> = ({
  navigation,
}) => {
  ...
  const pointsData = REA.useDerivedValue(() => {
    ...
    if (detectionResults.value.length > 0) {
      ...
      if (result) {
        ...
        pointsData =
          pointsData + location.points[1].x + ',' + location.points[1].y + ' ';
        pointsData =
          pointsData + location.points[2].x + ',' + location.points[2].y + ' ';
        pointsData =
          pointsData + location.points[3].x + ',' + location.points[3].y;
        data = pointsData;
      }
    }
